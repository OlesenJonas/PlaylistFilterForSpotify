...
enum ImGuiTableFlags_
{
    ...
    // [[CUSTOM]] Force vertical scrollbar
    ImGuiTableFlags_AlwaysVerticalScrollbar    = 1 << 28,  // Allow no sorting, disable default sorting. TableGetSortSpecs() may return specs where (SpecsCount == 0).
