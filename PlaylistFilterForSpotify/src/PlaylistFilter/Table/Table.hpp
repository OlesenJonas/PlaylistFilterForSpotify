...
class Table : TableAttributes<type>
{
  ...
  private:
    ...
    static constexpr ImGuiTableFlags flags =
        ...
        ImGuiTableFlags_SizingFixedFit | ImGuiTableFlags_Sortable | ImGuiTableFlags_NoSavedSettings;
    static constexpr ImGuiTableColumnFlags defaultColumnFlag =
        ImGuiTableColumnFlags_WidthFixed | ImGuiTableColumnFlags_NoResize;
    static constexpr ImGuiTableColumnFlags noSortColumnFlag = defaultColumnFlag | ImGuiTableColumnFlags_NoSort;
