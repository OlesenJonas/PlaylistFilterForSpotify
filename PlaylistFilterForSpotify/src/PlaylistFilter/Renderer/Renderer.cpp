...
Renderer::Renderer(App& app) : app(app)
{
    ...
    // Colors
    {
        ...
        colors[ImGuiCol_FrameBg] = ImVec4(0.37f, 0.51f, 0.65f, 0.19f);
        colors[ImGuiCol_FrameBgHovered] = ImVec4(0.37f, 0.51f, 0.65f, 0.66f);
        colors[ImGuiCol_FrameBgActive] = ImVec4(0.51f, 0.63f, 0.76f, 0.58f);
        colors[ImGuiCol_TitleBg] = ImVec4(0.16f, 0.20f, 0.24f, 1.00f);
        colors[ImGuiCol_TitleBgActive] = ImVec4(0.20f, 0.27f, 0.32f, 1.00f);
        ...
        colors[ImGuiCol_CheckMark] = ImVec4(0.87f, 0.93f, 1.00f, 0.86f);
        colors[ImGuiCol_SliderGrab] = ImVec4(0.87f, 0.93f, 1.00f, 0.86f);
        colors[ImGuiCol_SliderGrabActive] = ImVec4(0.87f, 0.93f, 1.00f, 0.86f);
        colors[ImGuiCol_Button] = ImVec4(0.13f, 0.28f, 0.39f, 0.71f);
        colors[ImGuiCol_ButtonHovered] = ImVec4(0.26f, 0.98f, 0.49f, 0.58f);
        colors[ImGuiCol_ButtonActive] = ImVec4(0.26f, 0.98f, 0.49f, 0.70f);
        colors[ImGuiCol_Header] = ImVec4(0.13f, 0.28f, 0.39f, 0.59f);
        ...
        colors[ImGuiCol_PlotHistogram] = ImVec4(0.26f, 0.98f, 0.49f, 0.70f);
